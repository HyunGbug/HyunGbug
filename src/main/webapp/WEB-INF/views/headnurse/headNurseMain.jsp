	...
	<header>
		...
		<nav>
			...
			<div class="profile-info">
				<img id="profile-image" src="/images/ProfileImage/현율무_jisoo.png"
					alt="Profile Image">
			...
			<form id="patientVisitForm">
				...
				<div class="form-group">
					<label for="doctorSelect">담당 의사:</label> <select id="doctorSelect"
						...
						onchange="fetchDoctorNoByName(this.value)">
						<option value="">의사를 선택하세요</option>
						<!-- 의사 목록이 여기에 추가됩니다 -->
					</select> <input type="hidden" id="doctorNo" name="doctorNo">
				</div>
				<div class="form-group">
					<label for="nurseSelect">담당 간호사:</label> <select id="nurseSelect"
						name="nurseName" required
						onchange="fetchNurseNoByName(this.value)">
						<option value="">간호사를 선택하세요</option>
						<!-- 간호사 목록이 여기에 추가됩니다 -->
					</select> <input type="hidden" id="nurseNo" name="nurseNo">
				</div>
				<div class="form-group">
